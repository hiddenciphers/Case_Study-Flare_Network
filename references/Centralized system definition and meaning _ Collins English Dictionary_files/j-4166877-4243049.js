//Generated:2023-03-18 01:23:49// 6-273
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4166877 || '',
    guid: window.ftGUID_4166877 || '',
    confID: window.ftConfID_4166877 || '0',
    ftReturn: window.ftReturn_4166877 || '',
    keyword: window.ftKeyword_4166877 || '',
    ftId: window.ftId_4166877 || '',
    ftImpId: window.ftImp4166877 && window.ftImp4166877.impID || '',
    gdpr: window.ftImp4166877 && window.ftImp4166877.gdpr || '',
    gdpr_consent: window.ftImp4166877 && window.ftImp4166877.gdpr_consent || '',
    gdpr_pd: window.ftImp4166877 && window.ftImp4166877.gdpr_pd || '',
    us_privacy: window.ftImp4166877 && window.ftImp4166877.us_privacy || '',
    campaignID: '115751',
    cID: '116264',
    pID: '4166877',
    creativeID: '4243049',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115751&sid=18330&plc=4166877&num=&adid=&advid=&adsrv=29&btreg=4166877&btadsrv=flashtalking&crt=4243049&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115751;4166877;4243049;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/au/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?225475073-4166877;4243049;',
    centreAd: false,
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/416/4166877/4243049/image/4243049.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115751;4166877;202;pixel;DV360;DV360FY20AcrobatCTXCustomIntentCompetitiveAUDSKBAN300x250/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115751;4166877;4243049;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/au/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display",
    divID: 'ftdiv4166877',
    altimgID: 'ftalt4166877',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4166877 && parseInt(window.ftImp4166877.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4166877') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4166877'),
    pageVisible: 'maybe',
...
(function(o) {
    ...
    o.frameID = 'ftframe4166877';
    o.file = 'http://cdn.flashtalking.com/116264/4243049/index.html';
    o.altImg = 'https://servedby.flashtalking.com/imp/8/115751;4166877;204;gif;DV360;DV360FY20AcrobatCTXCustomIntentCompetitiveAUDSKBAN300x250/?';
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4166877").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4166877").style.display = "none";
		    }
		});
	}
}(ft4166877));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115751&l2=DV360&l3=4166877&l4=4243049&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115751&l2=DV360&l3=4166877&l4=4243049&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4166877;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4166877;
