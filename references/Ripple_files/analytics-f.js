...
(function(window, document){
  ...
  var postClickToFirmTrack = function(data){
    ...
    if(window.TriblioAssetNameTracking && window.TriblioAssetNameTracking.postAssetNames && data && Object.keys(data).length){
      window.TriblioAssetNameTracking.postAssetNames({
        action: "click",
